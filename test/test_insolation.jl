...
# Test insolation with solar_variability
solar_variability = TSIDataSpline()
F_solar, S_solar, μ_solar, ζ_solar =
    insolation(date, lat, lon, param_set, od, milankovitch, solar_variability)
...
F_solar, S_solar, μ_solar, ζ_solar =
    insolation(date, lat, lon, diff_param_set, od, milankovitch, solar_variability)

...
title = format("g = {:.2f}, w = {:.2f}, e = {:.2f}", γ1, ϖ0, e0)
plot_day_lat_insolation(days,lats,F2,"YlOrRd",  title, "insol_example3a.png")

title = format("insolation diff: g0 = {:.2f}, g1 = {:.2f}", γ0, γ1)
...
title = format("g = {:.2f}, w = {:.2f}, e = {:.2f}", γ2, ϖ0, e0)
plot_day_lat_insolation(days,lats,F3,"YlOrRd", title, "insol_example4a.png")

title = format("insolation diff: g0 = {:.2f}, g1 = {:.2f}", γ0, γ2)
...
title = format("g = {:.2f}, w = {:.2f}, e = {:.2f}", γ3, ϖ0, e0)
plot_day_lat_insolation(days,lats,F4,"YlOrRd", title, "insol_example5a.png")

title = format("insolation diff: g0 = {:.2f}, g1 = {:.2f}", γ0, γ3)
...
title = format("g = {:.2f}, w = {:.2f}, e = {:.2f}", γ4, ϖ0, e0)
plot_day_lat_insolation(days,lats,F5,"YlOrRd", title, "insol_example6a.png")

title = format("insolation diff: g0 = {:.2f}, g1 = {:.2f}", γ0, γ4)
